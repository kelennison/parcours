...
# Install system dependencies required for R and tidyverse
...
# Install Bioconductor and required CRAN packages in R
RUN R -e "install.packages('BiocManager', repos='https://cloud.r-project.org')" \
    && R -e "BiocManager::install('ggtree', update = FALSE, ask = FALSE)" \
    && R -e "install.packages(c('tidyverse', 'ape'), repos='https://cloud.r-project.org', dependencies = TRUE)"
